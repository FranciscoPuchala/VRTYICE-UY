...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (introCard) {
        introCard.addEventListener('mouseenter', function() {
            this.style.zIndex = '10';
        });
        
        introCard.addEventListener('mouseleave', function() {
            this.style.zIndex = '1';
        });
    }
    ...
    // ===== SCOPE LIST ITEMS PROGRESSIVE REVEAL =====
    const scopeListItems = document.querySelectorAll('.scope-list li');
    
    const scopeObserver = new IntersectionObserver(function(entries) {
    ...
    const icons = document.querySelectorAll('.feature-icon, .intro-icon, .scope-image');
    ...
    // ===== CONSOLE LOG =====
    console.log('Vértice - Integración de Sistemas Page - Initialized successfully! 🚀');
    console.log('Feature cards loaded:', featureCards.length);
    console.log('Benefit items loaded:', benefitItems.length);
});